...
const OurTeam = () => {
   return <HelpLayout>
      ...
      <div data-section="section">
         <p>Headquartered in London we have rapidly grown to 80 people and expanded into sunny LA and snowy Turin.Everyone at FACEIT has a passion for competitive gaming and esports and are experts in their field. From former pro players and shoutcasters, media directors, developers, product managers, lawyers, partnership managers, human resources, finance; FACEIT caters a diverse and international team.</p>
