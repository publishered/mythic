...
import styles from './ProfilePageFriendsItem.module.css'

const ProfilePageFriendsItem = ({avatar_path, nickname, country_code, friend_id, getAllFriendsFunc}) => {
...
export default ProfilePageFriendsItem