import DefaultSection from '../UI/defaultSection/DefaultSection'
...
const TermsOfService = () => {
   return <DefaultSection>
      <div className={styles.terms__inner}>
         ...
         <div className={styles.terms__section}>
            <h2 className={styles.terms__title}>Incorporated rules and policies</h2>
            <div className={styles['terms__section-content']}>
               <p>Your account should not have any bans, including bans in the Steam community, trade ban, community ban and hidden ban. The exception is VAC BAN, if it is present at a game that is not present in our service or in tournaments of which you are not going to take part.</p>
         ...
         <div className={styles.terms__section}>
            <h2 className={styles.terms__title}>Miscellaneous</h2>
            <div className={styles['terms__section-content']}>
               ...
               <div className={styles['terms__section-content-item']}>
                  ...
                  <p>Choice of law and jurisdiction. These Terms are governed by Delaware state law, without reference to its conflict of laws provisions. You agree that any suit arising from the Services must take place in a court located in Delaware state.</p>
               </div>
               <div className={styles['terms__section-content-item']}>
